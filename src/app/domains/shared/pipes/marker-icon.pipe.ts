...
export class MarkerIconPipe implements PipeTransform {
  ...
  private readonly iconContent = `
      <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="#ff2825" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M12 9a3 3 0 1 0 0 6a3 3 0 0 0 0 -6z" fill="#fff" />
      </svg>
    `;
